...
Stage 0～3 / Batch A～D 以及 Batch D.1-A/B 已完成。下一项 GPU pipeline 工程任务是
**Batch D.1-C/D：仅在前置 telemetry 证明必要时实验 queue reservation 与 device-local RAW
staging**；CPU decoder 主线仍从
