...
Stage 0～3 / Batch A～D 以及 Batch D.1-A～D 已完成；D.1-C/D 的 queue/staging 候选均记录
no-go。下一项主线任务是 **Batch E-A：更新并冻结同时覆盖 compression 6/7 的 official truth
source**；CPU decoder 主线仍从
