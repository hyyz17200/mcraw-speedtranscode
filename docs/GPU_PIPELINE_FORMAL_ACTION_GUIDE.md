...
Stage 0～3 / Batch A～D 以及 Batch D.1-A 已完成。下一项 GPU pipeline 工程任务是
**Batch D.1-B：修正 effective async depth，并执行真实帧 depth matrix**；随后按结果决定
queue/staging 工作是否继续。CPU decoder 主线仍从
