...
void write_sidecar(const std::filesystem::path& path,
    ...
    nlohmann::json document = {
        ...
        {"pipeline", {
            ...
            {"performance_mode", pipeline.performance_mode},
            {"intermediate_storage", pipeline.intermediate_storage},
            {"di_implementation", pipeline.di_implementation},
            {"dither_mode", pipeline.dither_mode},
            {"demosaic_implementation", pipeline.demosaic_implementation},
                {"async_depth", pipeline.async_depth},
                {"effective_async_depth", pipeline.effective_async_depth},
                {"compute_pool_size", pipeline.compute_pool_size},
                {"compute_queue_family", pipeline.compute_queue_family},
                {"compute_queue_index", pipeline.compute_queue_index},
